...
@Component({
  selector: 'app-basic-peer-connection-stab',
  templateUrl: './basic-peer-connection-stab.component.html',
  styleUrls: ['./basic-peer-connection-stab.component.css']
})
export class BasicPeerConnectionStabComponent implements OnInit {
